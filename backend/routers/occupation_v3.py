"""
Occupation Router v3.0 - Spool occupation operations.

DEPRECATED: This router maintains v3.0 endpoints at /api/v3/occupation/* for backward compatibility.
New v4.0 endpoints are available at /api/v4/occupation/*.
...
Key features:
- POST /api/v3/occupation/tomar: Take single spool (Redis lock + state machine transition)
- POST /api/v3/occupation/pausar: Pause work on spool (release lock + update Estado_Detalle)
- POST /api/v3/occupation/completar: Complete work on spool (completar transition + release lock)
- POST /api/v3/occupation/batch-tomar: Take multiple spools (up to 50, direct OccupationService)
...
async def tomar_spool(
    ...
    """
    [v3.0 DEPRECATED] Take a spool (acquire occupation lock).
...
async def pausar_spool(
    ...
    """
    [v3.0 DEPRECATED] Pause work on a spool (mark as paused and release lock).
...
async def completar_spool(
    ...
    """
    [v3.0 DEPRECATED] Complete work on a spool (mark operation complete and release lock).
...
async def batch_tomar_spools(
    ...
    """
    [v3.0 DEPRECATED] Take multiple spools in batch (up to 50).
