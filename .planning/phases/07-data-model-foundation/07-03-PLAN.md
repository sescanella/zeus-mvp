...
<task type="auto">
  ...
  <verify>PYTHONPATH=/Users/sescanella/Proyectos/KM/ZEUES-by-KM pytest tests/unit/test_union_repository.py -v</verify>
...
3. Run tests: `PYTHONPATH=/Users/sescanella/Proyectos/KM/ZEUES-by-KM pytest tests/unit/test_union_repository.py -v`
</verification>

<success_criteria>
- [ ] Union model validates all 18 fields with proper types
- [ ] UnionRepository uses dynamic column mapping exclusively
- [ ] Repository can query by TAG_SPOOL efficiently
