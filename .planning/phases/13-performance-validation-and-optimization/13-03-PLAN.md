...
<task type="auto">
  <name>Task 3: Add GlobalRateLimitMonitor singleton</name>
  <files>backend/utils/rate_limiter.py</files>
  <action>
    Add simple singleton pattern for global rate limit monitoring.
    ...
    2. Simple integration:
       - get_instance() class method for singleton access
       - Thread-safe operations with lock
       - Basic metrics export as dictionary

    This provides a simple global monitor without over-engineering.
  </action>
  <verify>
