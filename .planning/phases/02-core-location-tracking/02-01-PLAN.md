...
<task type="auto">
  ...
  <verify>pytest backend/services/redis_lock_service.py -k "test_acquire_lock" (will add tests in Plan 4)</verify>
  <done>RedisLockService provides atomic lock operations with ownership verification</done>
</task>
