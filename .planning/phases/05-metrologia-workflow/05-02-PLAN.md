...
<task type="auto">
  ...
  <verify>curl -X POST http://localhost:8000/api/metrologia/completar -H "Content-Type: application/json" -d '{"tag_spool":"TEST","worker_id":1,"resultado":"APROBADO"}' | grep -E "404|message"</verify>
