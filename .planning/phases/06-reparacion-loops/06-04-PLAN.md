...
<task type="auto">
  ...
  <verify>python -c "from backend.services import EstadoDetalleService; print('Override detection service created')"</verify>
...
<task type="auto">
  ...
  <verify>python -m pytest tests/unit/test_reparacion_service.py tests/unit/test_supervisor_override.py -v</verify>
...
# Check supervisor override detection
python -m pytest tests/unit/test_supervisor_override.py -v
