...
class TestMetadataEventBuilderTomar:
    ...
    def test_tomar_event_builder(self):
        ...
        # Verify generated fields (id and timestamp are generated by log_event, not build)
...
class TestMetadataEventBuilderMetrologia:
    ...
    def test_metrologia_aprobado(self):
        """Builder creates COMPLETAR_METROLOGIA event for APROBADO."""
        event = (
            MetadataEventBuilder()
        ...
        assert event["evento_tipo"] == "COMPLETAR_METROLOGIA"
        assert event["accion"] == "COMPLETAR"

    def test_metrologia_rechazado(self):
        """Builder creates COMPLETAR_METROLOGIA event for RECHAZADO."""
        event = (
            MetadataEventBuilder()
